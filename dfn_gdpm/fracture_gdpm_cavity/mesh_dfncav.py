...
#  pcavity = motet2.createpts('rtp',npts=(10,10),mins=(0.,theta1,phi1),maxs=(radius,theta2,phi2))
#  motet2.createpts('rtp',npts=(10,10),mins=(0.,theta1,phi1),maxs=(radius,theta2,phi2),connect=True)
#  motet2.setatt('imt',3)
#  motet2.connect()

#  pcavity = motet2.pset_geom_rtp(mins=(0.,theta1,phi1), maxs=(radius,theta2,phi2), ctr=(0,0,-cav_center_depth))
